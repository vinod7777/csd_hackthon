...
<a class="bg-primary text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-secondary transition-colors shadow-sm" href="register.php">Register</a>
</div>
...
<p class="text-sm text-gray-200">Organized by Department of CSD &amp; Institution's Innovation Council</p>
</div>
</div>
...
<div class="flex items-center">
<input class="h-4 w-4 text-primary focus:ring-primary border-gray-600 rounded bg-gray-800" id="remember" name="remember" type="checkbox"/>
